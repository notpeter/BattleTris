...
commands with fast drop. This does not alter production planning or game rules.
The runner waits for fast descent and the landing window before reusing a seat.
...
invitations, readiness, gameplay, either-player pause, responsive layouts, reload
